...
const Profile = () => {
  ...
  const handleInputChange = (event) => {
    ...
    if (name === "oldPassword" && value === profileData.password) {
      // If old password matches, clear the new password field
      setFormDatas({ ...formDatas, password: "" });
    }

    // if (name === "password" && oldPassword === profileData.password) {
  ...
  const handleApi = () => {
    ...
    axios
      .put(`https://651be95a194f77f2a5af127c.mockapi.io/users/${user_id}`, {
        image: image1,
      })
      .then((res) => {
              ...
              <div className="card p-4 rounded-5">
                <div className="row">
                      ...
                      <div className="de_tab tab_simple">
                        ...
                        <div className="de_tab_content">
                          <div className="tab-1">
                            ...
                            <div className="row">
                              <div className="col-lg-6 mb20 mt-2">
                                <h5>Old Password</h5>
                                <input
                                  type="password"
                                  name="oldPassword"
                              ...
                              <div className="col-lg-6 mb20">
                                ...
                                <input
                                  ...
                                  required
                                />
                                <div className="col-lg-12 mb20"></div>
                              </div>
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="col-lg-6 mb20 mt-4">
                    ...
                    />
                    <button className="btn mt-3 handle" onClick={handleApi}>
                      Upload your image
                    </button>
                  </div>
                </div>
